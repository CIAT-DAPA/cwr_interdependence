...
work_dir <- 'D:/Tobackup/_hmcfw/PGR_interdependence/analysis/interdependence_circos/_regions'
...
write.csv(data_exp, paste(work_dir, "/_outputs/circos/FS/FS_items_country_regions_2016_2_8.csv", sep=''), row.names=F)

data_exp <- read.csv(paste(work_dir, "/_outputs/circos/FS/FS_items_country_regions_2016_2_8.csv", sep=''))
...
write.csv(data_country, paste(work_dir, "/_outputs/circos/FS/FS_sum_country_regions_2016_2_8.csv", sep=''), row.names=F)

# Load data

data_country <- read.csv(paste(work_dir, "/_outputs/circos/FS/FS_sum_country_regions_2016_2_8.csv", sep=''))
...
write.csv(data_country, paste(work_dir,"/_outputs/circos/FS/FS_sum_country_regions_cropregions_2016_2_8.csv", sep=''), row.names=F)
...
names(cOrgData_region)[6:7] <- c("Rcode_recipients","R_recipients")
...
names(cOrgData_region)[7:8] <- c("R_origin","Rcode_origin")

cOrgData_region <- cOrgData_region[,c("R_origin","Rcode_origin","R_recipients","Rcode_recipients","Element","Y2009","Y2010","Y2011")]
