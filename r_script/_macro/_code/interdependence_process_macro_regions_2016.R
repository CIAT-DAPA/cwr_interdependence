...
comm_data_set <- comm_data_set[,c("Item","Region_macronew")]
names(comm_data_set)[2] <- 'Region_crops'

ctry_data_set <- ctry_data_set[,c('Country','Region_macronew')]
names(ctry_data_set)[2] <- 'Region'
...
if(dir.exists(paste(work_dir, '/_outputs/total_db_summary', sep=''))==FALSE){dir.create(paste(work_dir, '/_outputs/total_db_summary', sep=''))} else {cat('This folder exists\n')}
...
elements <- c("Fat_supply_quantity", "Food_supply", "Food_supply_quantity", "Protein_supply_quantity")
if(dir.exists(paste(work_dir, '/_outputs/maximum_dependence', sep=''))==FALSE){dir.create(paste(work_dir, '/_outputs/maximum_dependence', sep=''))} else {cat('This folder exists\n')}
if(dir.exists(paste(work_dir, '/_outputs/maximum_dependence/total_native', sep=''))==FALSE){dir.create(paste(work_dir, '/_outputs/maximum_dependence/total_native', sep=''))} else {cat('This folder exists\n')}
...
elements <- c("Fat_supply_quantity", "Food_supply", "Food_supply_quantity", "Protein_supply_quantity")
if(dir.exists(paste(work_dir, '/_outputs/minimum_dependence', sep=''))==FALSE){dir.create(paste(work_dir, '/_outputs/minimum_dependence', sep=''))} else {cat('This folder exists\n')}
if(dir.exists(paste(work_dir, '/_outputs/minimum_dependence/total_nspecified', sep=''))==FALSE){dir.create(paste(work_dir, '/_outputs/minimum_dependence/total_nspecified', sep=''))} else {cat('This folder exists\n')}
...
elements <- c("Fat_supply_quantity", "Food_supply", "Food_supply_quantity", "Protein_supply_quantity")
if(dir.exists(paste(work_dir, '/_outputs/minimum_dependence/percent_nspecified', sep=''))==FALSE){dir.create(paste(work_dir, '/_outputs/minimum_dependence/percent_nspecified', sep=''))} else {cat('This folder exists\n')}
...
max_dir <- "/_outputs/maximum_dependence"
min_dir <- "/_outputs/minimum_dependence"

labels <- list.files(paste(work_dir, max_dir, sep=''), pattern=".csv")
labels <- gsub(pattern="Maximum_dependence_", replacement="", labels)
labels <- gsub(pattern=".csv", replacement="", labels)

max_dep_files <- list.files(paste(work_dir, max_dir, sep=''), pattern=".csv", full.names=T)
min_dep_files <- list.files(paste(work_dir, min_dir, sep=''), pattern=".csv", full.names=T)
...
if(dir.exists(paste(work_dir, '/_outputs/combined_dependence', sep=''))==FALSE){dir.create(paste(work_dir, '/_outputs/combined_dependence', sep=''))} else {cat('This folder exists\n')}
