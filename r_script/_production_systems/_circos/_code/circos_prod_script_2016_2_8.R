...
write.csv(data_exp, paste(work_dir, "/_circos/Prod/Prod_items_country_regions_2016_2_8.csv", sep=''), row.names=F)

# 

data_exp <- read.csv(paste(work_dir, "/_circos/Prod/Prod_items_country_regions_2016_2_8.csv", sep=''))
...
write.csv(data_country, paste(work_dir, "/_circos/Prod/Prod_sum_country_regions_2016_2_8.csv", sep=''), row.names=F)

# Load data

data_country <- read.csv(paste(work_dir, "/_circos/Prod/Prod_sum_country_regions_2016_2_8.csv", sep=''))
