...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
# INTERDEPENDENCE STUDY - PROCESSING DATA - Production
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
...
main_data_set <- read.csv(paste(work_dir, "/_inputs/prod_2009-2011_mean_final_mc_fm_selcom_selcoun.csv", sep=""), header=T)
...
write.csv(summary_results[[1]], paste(work_dir, "/_outputs/by_value/results_dependence/Total_summary_db.csv", sep=""), row.names=F)
...
write.csv(test1, paste(work_dir, "/_outputs/by_value/prod_countries_regions_all_merge.csv",sep=""), row.names=F)
...
write.csv(test3, paste(work_dir, "/_outputs/by_value/prod_countries_regions_dupregionscrops.csv",sep=""), row.names=F)
...
write.csv(dependence_results[[1]], paste(work_dir, "/_outputs/by_value/results_dependence/Total_native.csv", sep=""), row.names=F)

## Read db summary
summary_results <- read.csv(paste(work_dir, "/_outputs/by_value/results_dependence/Total_summary_db.csv", sep=""))
country <- sort(as.character(unique(summary_results$Country)))

## Read maximum dependence data
dependence_results <- read.csv(paste(work_dir, "/_outputs/by_value/results_dependence/Total_native.csv", sep=""))
...
write.csv(max_dependence_results[[1]], paste(work_dir, "/_outputs/by_value/results_dependence/Maximum_dependence.csv", sep=""), row.names=F)

# Calculate contribution of all commodities where region = "Not_Specified"

test2 <- read.csv(paste(work_dir, "/_outputs/by_value/prod_countries_regions_all_merge.csv",sep=""), header=T)

test4 <- test2[test2$Region_crops=="Not_Specified",]
rownames(test4) <- 1:nrow(test4)
write.csv(test4, paste(work_dir, "/_outputs/by_value/prod_countries_notspecified.csv",sep=""), row.names=F)
...
write.csv(nspecified_results[[1]], paste(work_dir, "/_outputs/by_value/results_dependence/Total_nspecified.csv", sep=""), row.names=F)

# Read Not specified data

nspecified_results <- read.csv(paste(work_dir, "/_outputs/by_value/results_dependence/Total_nspecified.csv", sep=""))
...
write.csv(percent_nspecified_results[[1]], paste(work_dir, "/_outputs/by_value/results_dependence/Nspecified_percent.csv", sep=""), row.names=F)
...
percent_nspecified_results <- read.csv(paste(work_dir, "/_outputs/by_value/results_dependence/Nspecified_percent.csv", sep=""))
...
write.csv(min_dependence_results[[1]], paste(work_dir, "/_outputs/by_value/results_dependence/Minimum_dependence.csv", sep=""), row.names=F)

#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
# Put maximum and minimum together
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#

max_dep_files <- read.csv(paste(work_dir, "/_outputs/by_value/results_dependence/Maximum_dependence.csv", sep=""))
min_dep_files <- read.csv(paste(work_dir, "/_outputs/by_value/results_dependence/Minimum_dependence.csv", sep=""))
...
write.csv(combined, paste(work_dir, "/_outputs/by_value/results_dependence/combined_dependence_prodval.csv", sep=''), row.names=F)
