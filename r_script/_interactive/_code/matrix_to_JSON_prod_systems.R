...
all_elements <- read.csv(paste(work_dir, '/_interactive/_useful_info/prod_sum_regions_and_origins.csv', sep=''))
...
top5_info <- read.csv(paste(work_dir, '/_interactive/_useful_info/most_important_prod_crop_flows.csv', sep=''))
