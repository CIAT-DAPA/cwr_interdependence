...
work_dir <- 'D:/Tobackup/_hmcfw/PGR_interdependence/analysis/interdependence_circos/'
...
write.csv(fs_region_country_percent, paste(work_dir, '/_interactive/_useful_info/fs_regioncrops_to_country_2016_2_8.csv', sep=''), row.names=FALSE)

### Horizontal way

work_dir <- 'D:/Tobackup/_hmcfw/PGR_interdependence/analysis/interdependence_circos/'
fs_region_country_percent <- read.csv(paste(work_dir, '/_interactive/_useful_info/fs_regioncrops_to_country_2016_2_8.csv', sep=''))
...
write.csv(fs_region_country_percent, paste(work_dir, '/_interactive/_useful_info/fs_regioncrops_to_country_matrix_2016_2_8.csv', sep=''), row.names=FALSE)
...
write.csv(prod_region_country_percent, paste(work_dir, '/_interactive/_useful_info/prod_regioncrops_to_country_2016_2_8.csv', sep=''), row.names=FALSE)

### Horizontal way

work_dir <- 'D:/Tobackup/_hmcfw/PGR_interdependence/analysis/interdependence_circos/'
prod_region_country_percent <- read.csv(paste(work_dir, '/_interactive/_useful_info/prod_regioncrops_to_country_2016_2_8.csv', sep=''))
...
write.csv(prod_region_country_percent, paste(work_dir, '/_interactive/_useful_info/prod_regioncrops_to_country_matrix_2016_2_8.csv', sep=''), row.names=FALSE)
